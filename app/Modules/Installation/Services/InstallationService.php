...
class InstallationService
{
    ...
    {
        // Save clinic settings to database/config
        config([
            'app.name' => $data['clinic_name'],
            'clinic.email' => $data['email'],
            'clinic.address' => $data['address'],
            'clinic.phone' => $data['phone'],
            'clinic.tax_office' => $data['tax_office'],
            'clinic.tax_number' => $data['tax_number']
        ]);

        // You might want to save these to database as well
    }
