                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="payment_method" name="payment_method" class="mt-1 block w-full rounded-lg border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                ...
                                <option value="nakit" @selected(old('payment_method') == 'nakit')>Nakit</option>
                                <option value="havale" @selected(old('payment_method') == 'havale')>Havale</option>
                                <option value="kredi_karti" @selected(old('payment_method') == 'kredi_karti')>Kredi Kartı</option>
                                <option value="cek" @selected(old('payment_method') == 'cek')>Çek</option>
                            </select>
