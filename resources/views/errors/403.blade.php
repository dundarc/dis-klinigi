...
<body>
    <div class="card">
        ...
        @php
            ...
            \App\Services\ErrorLoggerService::logErrorPage(request(), 403, 'Forbidden Access');
        @endphp
        ...
        <div class="debug-info">
            ...
            <div class="debug-grid">
                <div class="debug-item">
                    ...
                    <div class="debug-value">403 - Forbidden</div>
                </div>
                <div class="debug-item">
                ...
                <div class="debug-item">
                    <div class="debug-label">Kullanıcı Rolü</div>
                    <div class="debug-value">{{ auth()->user()->role ? auth()->user()->role->label() : 'Rol Yok' }}</div>
                </div>
                <div class="debug-item">
                ...
                <div class="debug-item">
                    <div class="debug-label">Gerekli Yetkiler</div>
                    <div class="debug-value">{{ implode(', ', Route::current()->middleware() ?? []) ?: 'Belirtilmemiş' }}</div>
                </div>
                <div class="debug-item">
            ...
            <div class="debug-actions">
                <a href="mailto:developer@dundarc.com.tr?subject=403%20Error%20Report&body=URL:%20{{ urlencode(request()->fullUrl()) }}%0AUser:%20{{ auth()->user()->name ?? 'Unknown' }}%0ARole:%20{{ auth()->user()->role ? auth()->user()->role->label() : 'None' }}%0ATime:%20{{ now()->format('d.m.Y H:i:s') }}%0AReferer:%20{{ urlencode(request()->header('referer') ?? 'None') }}">
