            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-xl border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <h4 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Yedek Oluştur</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                                Tüm veritabanının bir yedeğini oluşturun. Bu işlem mevcut tüm verilerinizi güvenli bir şekilde saklar.
                            </p>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-xl border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <h4 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Verileri Geri Yükle</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                                En son yedekten geri yükleme yapın. Bu işlem mevcut verilerin üzerine yazacaktır.
                            </p>
                ...
                <div class="p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                                Bu işlem, kullanıcılar hariç tüm verileri (hastalar, randevular, faturalar vb.) kalıcı olarak silecektir. Bu işlem geri alınamaz.
                            </p>
