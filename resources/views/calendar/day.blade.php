                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    @if($currentView === 'day')
                        <form method="GET" action="{{ route('calendar') }}" class="inline-flex items-center gap-2">
                            ...
                            @endforeach
                            <input type="date" name="goto_date" value="{{ $gotoDate }}" class="rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:border-gray-700 dark:text-gray-200">
                            <x-primary-button type="submit">{{ __('Git') }}</x-primary-button>
                        </form>
                    @endif
