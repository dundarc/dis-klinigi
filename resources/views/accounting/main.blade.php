        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-yellow-100 dark:bg-yellow-900/50 p-6 rounded-lg shadow">
                    <h3 class="text-lg font-semibold text-yellow-800 dark:text-yellow-300">Taksitli</h3>
                ...
                <!-- Gelecek Ödemeler (Örnek) -->
                <div class="bg-blue-100 dark:bg-blue-900/50 p-6 rounded-lg shadow">
                    <h3 class="text-lg font-semibold text-blue-800 dark:text-blue-300">Bu Ay Beklenen</h3>
                    <p class="text-3xl font-bold text-blue-900 dark:text-blue-200 mt-2">... Adet</p>
                    <p class="text-md text-blue-700 dark:text-blue-400">... TL</p>
                </div>
            </div>

            <!-- Son Kesilen Faturalar Tablosu -->
            <x-card>
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Son Kesilen Faturalar</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @empty
                                <tr><td colspan="5" class="text-center py-4 text-gray-500">Henüz hiç fatura kesilmemiş.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
