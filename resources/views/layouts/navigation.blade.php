    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-18">
            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-4">
                ...
                <!-- Dark Mode Toggle -->
                <button @click="window.darkModeState.toggle()"
                    ...
                    <svg x-show="!window.darkModeState.isDark" x-cloak class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4 flex items-center justify-between">
                ...
                <button @click="window.darkModeState.toggle()"
                        ...
                        title="Tema değiştir">
                    <!-- Güneş ikonu (Light mode) -->
                    <svg x-show="!window.darkModeState.isDark" x-cloak class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/>
                    </svg>
                    <!-- Ay ikonu (Dark mode) -->
