<x-modal name="upload-file-modal" title="Dosya / Röntgen Yükle">
    <form @submit.prevent="submitFile($event.target)" class="p-6">
          <div class="mt-6 space-y-4">
             ...
             <div>
                 <x-input-label for="file_notes" value="Notlar (İsteğe bağlı)" />
                 <textarea id="file_notes" name="notes" rows="3" class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Dosya hakkında ek bilgiler..."></textarea>
             </div>
         </div>
