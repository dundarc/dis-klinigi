<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Hasta Bilgilerini Düzenle: {{ $patient->first_name }} {{ $patient->last_name }}
        </h2>
    </x-slot>
                    ...
                    <div class="space-y-6">
                            ...
                            <div>
                             ...
                             <div>
                                ...
                                <x-select-input id="gender" name="gender" class="mt-1 block w-full" required>
                                    <option value="male" @selected(old('gender', $patient->gender->value) == 'male')>Erkek</option>
                                    <option value="female" @selected(old('gender', $patient->gender->value) == 'female')>Kadın</option>
                                    <option value="other" @selected(old('gender', $patient->gender->value) == 'other')>Diğer</option>
                                </x-select-input>
                        ...
                        <div class="border-t pt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                             <div>
                                ...
                                <x-text-input id="phone_primary" name="phone_primary" type="text" class="mt-1 block w-full" :value="old('phone_primary', $patient->phone_primary)" required />
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea id="address_text" name="address_text" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('address_text', $patient->address_text) }}</textarea>
                        ...
                        <div class="border-t pt-6 space-y-4">
                            <div class="flex items-center">
                                <input id="has_private_insurance" name="has_private_insurance" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" @checked(old('has_private_insurance', $patient->has_private_insurance))>
                            ...
                            <div class="flex items-center">
                                <input id="consent_kvkk" name="consent_kvkk" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" @checked(old('consent_kvkk', $patient->consent_kvkk_at))>
                                <label for="consent_kvkk" class="ms-2 block text-sm text-gray-900 dark:text-gray-100">KVKK Onayı Verildi</label>
                            </div>
                        </div>

                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('patients.show', $patient) }}" class="text-sm text-gray-600 dark:text-gray-400 hover:underline">
                                İptal
                            </a>
